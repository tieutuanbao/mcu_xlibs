 ...
 */
void i2s_init(i2s_clock_div_t clock_div, i2s_pins_t pins) {  
    if (pins.data) {
    ...
    I2S.conf = (I2S.conf & (~I2S_CONF_BCK_DIV_MASK)) | (I2S_CONF_BCK_DIV_POS << clock_div.bclk_div);
    I2S.conf = (I2S.conf & (~I2S_CONF_CLKM_DIV_MASK)) | (I2S_CONF_CLKM_DIV_POS << clock_div.clkm_div);
}
 ...
 */
i2s_clock_div_t i2s_freq_to_clock_div(int32_t freq) {
